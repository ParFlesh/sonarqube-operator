...
func (r *ReconcileSonarQubeServer) verifyServerStatus(_ *sonarsourcev1alpha1.SonarQubeServer, apiClient api_client.APIReader) (*api_client.Status, error) {
...
func (r *ReconcileSonarQubeServer) verifyServerVersion(cr *sonarsourcev1alpha1.SonarQubeServer, status *api_client.Status) error {
...
func (r *ReconcileSonarQubeServer) verifyUpgrades(cr *sonarsourcev1alpha1.SonarQubeServer, apiClient api_client.APIReader) error {
